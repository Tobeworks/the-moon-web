...
export const POST = async ({ request }: APIContext) => {
  ...
  const { releaseSlug, releaseTitle, releaseArtist, testEmail, coverUrl, about } = body as Record<string, string>;
  ...
  try {
    ...
    await sendPromoEmail(testEmail, 'TEST', releaseTitle, releaseArtist, promoUrl, 'test-token', siteUrl, coverUrl || undefined, about || undefined);
